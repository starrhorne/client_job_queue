...
#
# Note that we use a Thin server, because jasmine-guard's other server options
# don't respect the rackup_config parameter.
#
guard :jasmine, :rackup_config => 'spec/dummy/config.ru', :server => :thin, :rackup_config => "spec/dummy/config.ru", :server_timeout => 60, :timeout => 60 do
